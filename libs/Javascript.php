...
class Javascript
{
    ...
    public function put()
    {
        ...
        if ( $arguments[0] instanceof Illuminate\Database\Eloquent\Collection ) {
            $variables = $arguments[0]->toArray();
    ...
    protected function buildNamespaceDeclaration()
    {
        ...
        return " var window.{$this->namespace} = window.{$this->namespace} || {};";
    }
